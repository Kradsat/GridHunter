Shader "Simple/Additive 3" {
	Properties {
		...
		_BottomColoer("BottomColoer", Float) = 0
	}
	...
	SubShader {
		...
		v2f vert (appdata_full v)
		{
			...
			o.color = _Transparent * _Color * v.color;
			return o;
		}
		ENDCG
		...
		Pass {
			...
			fixed4 frag (v2f i) : COLOR
			{
				...
				o = tex * tex2 * tex3 * tex4 * i.color+_Color*_BottomColoer*_Transparent;
