    ...
    SubShader {
        ...
        Pass {
			...
			#pragma skip_variants DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_ON LIGHTMAP_SHADOW_MIXING SHADOWS_SCREEN SHADOWS_SHADOWMASK VERTEXLIGHT_ON LIGHTPROBE_SH DIRECTIONAL
             ...
             float4 _MainColor;
			 float4 _LineForceColor;
             float _Dis;

			 fixed4 globeEffectBright;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 finalColor = emissive * _LineForceColor * lerp(1, globeEffectBright, _globeDayNightUse);
